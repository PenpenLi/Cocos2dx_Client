	...
	--创建一个裁剪节点用来实现遮罩的效果
		...
		local function onTouch1(sender, eventType)
			if eventType == ccui.TouchEventType.began then
				self.Selected1 = cc.Sprite:create("buyu1/res/fishui/Selected.png")
			...
			if eventType == ccui.TouchEventType.ended then	
				...
				GameScene.Rate:setVisible(true)
				self.Selected1:removeFromParent()
			end 
		end
		self.Coinopbtn = ccui.Button:create("buyu1/res/rate1.png","buyu1/res/rate2.png")
		...
		-- 	if eventType == ccui.TouchEventType.began then
		-- 		self.Selected2 = cc.Sprite:create("buyu1/res/fishui/Selected.png")
		-- 		clippingNode:addChild(self.Selected2,1)
		-- 		self.Selected2:setPosition(cc.p(self.Settlbtn:getPositionX(),self.Settlbtn:getPositionY()))
		-- 	end
		-- 	if eventType == ccui.TouchEventType.ended then
				
		-- 		-- if g_bolsuo == true or actor == true then
		-- 		-- 	--TextTipsUtils:showTips("开炮状态不可以下分")
		-- 		-- else 
		-- 		-- 	-- local und = Under.new(g_protion)
		-- 		-- 	-- local director = cc.Director:getInstance()
  --   -- 	-- 			local running_scene = director:getRunningScene()
  --   -- 	-- 			und:setAnchorPoint(cc.p(0.5,0.5))
  --   -- 	-- 			und:setPosition(winwidth/2,winheight/2)
  --   -- 	-- 			running_scene:addChild(und,100)
		-- 		-- end 
				
		-- 		self.Selected2:removeFromParent()
		-- 	end 
		-- end
		-- self.Settlbtn = ccui.Button:create("buyu1/res/fishui/Settlbtn.png","buyu1/res/fishui/Settlbtn2.png")
		-- self.Settlbtn:addTouchEventListener(onTouch2)
		-- self.Settlbtn:setPosition(cc.p(50,125))
		-- clippingNode:addChild(self.Settlbtn,2)

		local function onTouch3(sender, eventType)
			if eventType == ccui.TouchEventType.began then
				self.Selected3 = cc.Sprite:create("buyu1/res/fishui/Selected.png")
		...
		local function onTouch4(sender, eventType)
			if g_protion ~= nil then 
				if eventType == ccui.TouchEventType.began then				
					self.Selected4 = cc.Sprite:create("buyu1/res/fishui/Selected.png")
					...
					if global.g_mainPlayer:isInMatchRoom() == false then
	  					global.g_mainPlayer:setPlayerScore(g_gold[num] + math.floor(g_score[num]/g_protion))
	  				end 
					WarnTips.showTips({
		...
		self.Sioutbtn = ccui.Button:create("buyu1/res/fishui/Sioutbtn.png","buyu1/res/fishui/Sioutbtn2.png")
		...
		local function onTouch5(sender, eventType)
			if eventType == ccui.TouchEventType.began then
				...
				self.Selected5 = cc.Sprite:create("buyu1/res/fishui/Selected.png")
		...
		self.Recovbtn = ccui.Button:create("buyu1/res/fishui/Recovbtn.png","buyu1/res/fishui/Recovbtn2.png")
		...
		local sprite2 = cc.Sprite:create("buyu1/res/fishui/Drdownback.png")
		clippingNode:addChild(sprite2,1)

		--创建模板，裁剪节点将按照这个模板来裁剪区域
		self.stencil = cc.Sprite:create("buyu1/res/fishui/Coinopbtn2.png")
...
function Mask:updata()
	...
	self.schedulerID = scheduler:scheduleScriptFunc(function (dt)
		...
		if crtimer >= 1 then
			...
			self.btn = ccui.Button:create("buyu1/res/fishui/Boco2.png","buyu1/res/fishui/Boco2.png")                        
...
function Mask:Boco()
	self.scalY = 0.01
	self.baoc = cc.Sprite:create("buyu1/res/fishui/Boco.png")
	self.baoc:setPosition(0,-204)
	self:addChild(self.baoc,3)
	
	local baoc1 = cc.Sprite:create("buyu1/res/fishui/Boco.png")
