...
function Douvery:ctor()
    self.dobv = cc.Sprite:create("buyu1/res/card_ion.png") 
    self.dotx = cc.Sprite:create("buyu1/res/DoubleEffect11.png")
...
function Douvery:setTexter(a)
    if a == 1 then
        self.dobv:setTexture("buyu1/res/card_ion.png")
        self.dotx:setTexture("buyu1/res/DoubleEffect11.png")
    elseif a == 3 then
        self.dobv:setTexture("buyu1/res/freecardcard_ion.png")
        self.dotx:setTexture("buyu1/res/free_bullet.png")
    end 
end
