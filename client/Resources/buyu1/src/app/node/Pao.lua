...
function Pao:ctor()
    ...
    self.pao = cc.Sprite:createWithSpriteFrameName("XY_P101_00.png")
    ...
    self.preIndex = 0
    --[[
	self.pao = cc.Sprite:create("buyu1/res/fishui/1p.png")
	self.pao:setAnchorPoint(cc.p(0.5,0))
	self.pao:setScale(0.7)
	self:addChild(self.pao)
	self.rotate = 0
    self:addRate()]]
end
function Pao:addRate()
    self.RateScore = Digital:create("0","buyu1/res/fishui/NumPaoTai.png",16,23,string.byte("0"))
    ...
    --[[
	self.RateTex = RateLab.new()
	self.pao:addChild(self.RateTex)
	self.RateTex:setPosition(cc.p(55,30))]]
end
...
function Pao:setRsc()
	...
	--self.RateTex:setScale(-1)
	--self.RateTex:setPosition(cc.p(55,35))
end
...
function Pao:SwitchFrame(idx)
   ...
   -- print("self.oldIndex = "..self.oldIndex.." newidx = "..idx)
    ...
    local fw = cc.Sprite:createWithSpriteFrameName("XY_AimFW00.png")
    fw:setScale(1.5)
    function fwCallback()
        fw:removeFromParent()
    end
...
function Pao:setTexture(a)
	local texture1 = "buyu1/res/fishui/1p.png"
	local texture2 = "buyu1/res/fishui/2p.png"
	local texture3 = "buyu1/res/fishui/3p.png"
	local texture4 = "buyu1/res/fishui/4p.png"
	if a == 1 then
		self.sum = 1
...
function Pao:addBlast()
    ...
    --[[
	if self.sum == 1 then
		local blast = Blast.new()
    	self.pao:addChild(blast)
    	blast:setPosition(55,154)
    elseif self.sum == 2 then
    	local blast1 = Blast.new()
    	blast1:setPosition(35,154)
    	local blast2 = Blast.new()
    	blast2:setPosition(75,154)
    	self.pao:addChild(blast2)
    	self.pao:addChild(blast1)
	elseif self.sum == 3 then
		local blast1 = Blast.new()
    	blast1:setPosition(35,154)
    	local blast2 = Blast.new()
    	blast2:setPosition(55,154)
    	local blast3 = Blast.new()
    	blast3:setPosition(75,154)
    	self.pao:addChild(blast2)
    	self.pao:addChild(blast1)
    	self.pao:addChild(blast3)
    elseif self.sum == 4 then
    	 local blast1 = Blast.new()
    	blast1:setPosition(25,154)
    	local blast2 = Blast.new()
    	blast2:setPosition(40,154)
    	local blast3 = Blast.new()
    	blast3:setPosition(65,154)
    	local blast4 = Blast.new()
    	blast4:setPosition(80,154)
    	self.pao:addChild(blast2)
    	self.pao:addChild(blast1)
    	self.pao:addChild(blast3)
    	self.pao:addChild(blast4)
    end]]
end
function Pao:play()
