...
function SoundSetting:ctor()
  ...
  --       self.hobao = 1
  --       self.Coinopbtn:loadTextureNormal("buyu1/res/bgd2.png")
  --       --running_scene.bolhobao = false
  --       running_scene.hobaotext:setVisible(false)
  --     else 
  --       self.hobao = 0
  --       self.Coinopbtn:loadTextureNormal("buyu1/res/bgd1.png")
  ...
  -- self.Coinopbtn = nil
  -- if self.hobao == 0 then 
  --   self.Coinopbtn = ccui.Button:create("buyu1/res/bgd1.png","buyu1/res/bgd2.png")
  -- else
  --   self.Coinopbtn = ccui.Button:create("buyu1/res/bgd2.png","buyu1/res/bgd1.png")
  -- end 
  -- self.Coinopbtn:addTouchEventListener(onTouch1)
  -- self.ui_:addChild(self.Coinopbtn,111)
  -- self.Coinopbtn:setPosition(-20,-110)

  -- local spti = cc.Sprite:create("buyu1/res/hdij.png")
  -- spti:setPosition(100,-110)
  -- self.ui_:addChild(spti,111)
end

function SoundSetting:init()
  	self.effect_percent_ = global.g_mainPlayer:getLocalData("buyu1_effect", 100)
  	self.music_percent_ = global.g_mainPlayer:getLocalData("buyu1_music", 100)
...
function SoundSetting:onExit()
  	global.g_mainPlayer:setLocalData("buyu1_effect", self.effect_percent_)
  	global.g_mainPlayer:setLocalData("buyu1_music", self.music_percent_)
    -- global.g_mainPlayer:setLocalData("buyu1_hobao", self.hobao)
end  
