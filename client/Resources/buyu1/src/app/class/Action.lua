...
function Action:crICeBoom(point)
  ...
  local tex1 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light0.png")
  local tex2 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/ring1.png")
  local tex3 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light7.png")
  local tex4 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light8.png")
  local tex5 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light9.png")

  local emitter1 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/CoinRingEx.plist") 
  ...
  local emitter2 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/CoinBoomLight.plist") 
  ...
  local emitter3 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/CoinBoom.plist") 
  ...
  local emitter4 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/CoinBoom.plist") 
  ...
  local emitter5 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/CoinBoom.plist") 
...
function Action:crBoom(point)
  local tex1 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/ring6.png")
  local tex2 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light6.png")
  local emitter1 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/BoomRingEx.plist") 
  ...
  local emitter2 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/Boom.plist") 
...
function Action:crFishBoom(point)
  ...
  local tex1 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/ring3.png")
  local tex2 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/ring2.png")
  local tex3 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light1.png")
  local tex4 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light2.png")
  local tex5 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light3.png")

  local emitter1 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/IceRingEx.plist") 
  emitter1:setTexture(tex1)
  emitter1:setBlendAdditive(true) 
  emitter1:setAutoRemoveOnFinish(true)    --设置播放完毕之后自动释放内存  
  emitter1:setPosition(point)  
  ...
  local emitter2 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/IceRingEx1.plist") 
  emitter2:setTexture(tex2)
  emitter2:setBlendAdditive(true) 
  emitter2:setAutoRemoveOnFinish(true)    --设置播放完毕之后自动释放内存  
  emitter2:setPosition(point)  
  ...
  local emitter3 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/IceBoom1.plist") 
  emitter3:setTexture(tex3)
  emitter3:setBlendAdditive(true) 
  emitter3:setAutoRemoveOnFinish(true)    --设置播放完毕之后自动释放内存  
  emitter3:setPosition(point)  
  ...
  local emitter4 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/IceBoom2.plist") 
  emitter4:setTexture(tex4)
  emitter4:setBlendAdditive(true) 
  emitter4:setAutoRemoveOnFinish(true)    --设置播放完毕之后自动释放内存  
  emitter4:setPosition(point)  
  ...
  local emitter5 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/IceBoom3.plist") 
  emitter5:setTexture(tex5)
  emitter5:setBlendAdditive(true) 
  emitter5:setAutoRemoveOnFinish(true)    --设置播放完毕之后自动释放内存  
  emitter5:setPosition(point)  
...
function Action:crDing(point)
  local tex1 = cc.Director:getInstance():getTextureCache():addImage("buyu1/res/images/Particle/light5.png")
  local emitter1 = cc.ParticleSystemQuad:create("buyu1/res/images/Particle/ding.plist") 
  emitter1:setTexture(tex1)
  emitter1:setBlendAdditive(true) 
  emitter1:setAutoRemoveOnFinish(true)    --设置播放完毕之后自动释放内存  
  emitter1:setPosition(point)  
