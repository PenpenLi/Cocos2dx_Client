...
function red_envelope:ctor( fish_pos, cannon_pos,chair_id,fish_score)
       cclog("red_envelope:ctor(fish_pos, cannon_pos, chair_id, score)");
		...
		self:setScale(0.6);
        local t_bg_spr=cc.Sprite:create("qj_animal/res/game_res/red_envelope.png");
        local t_f_spr=cc.Sprite:create("qj_animal/res/game_res/red_envelope.png");
        local t_num = cc.LabelAtlas:_create(fish_score,"qj_animal/res/game_res/ChainShell/chainwin_scoreNum.png", 48, 70, 48);
