...
function SettingView:ctor()
	...
	local volumeMusic = global.g_mainPlayer:getLocalData("daxiao_music", 1)
	self.sliderSound_:setPercent(volumeMusic * 100)

	local volumeEffect = global.g_mainPlayer:getLocalData("daxiao_effect", 1)
...
function SettingView:onClose()
	...
	global.g_mainPlayer:setLocalData("daxiao_effect", volumeEffect)
	global.g_mainPlayer:setLocalData("daxiao_music", volumeMusic)
