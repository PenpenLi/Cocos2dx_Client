...
-- @Last Modified time: 2017-11-29 13:11:09
...
function GameSetting:ctor()
  ...
  self.effectPercent = global.g_mainPlayer:getLocalData("buyu2_effect", 100)
  self.musicPercent = global.g_mainPlayer:getLocalData("buyu2_music", 100)

  self.bg = cc.Sprite:create("buyu2/res/setting/setting_bg.png")
  self:addChild(self.bg)
  self.bg:setPosition(cc.p(640,360))


  self.CloseBtn = ccui.Button:create("buyu2/res/setting/close1.png","buyu2/res/setting/close2.png")
...
--[[
  self.musicSlider = ccui.Slider:create("buyu2/res/fishui/Silder_SoundBg.png")
  self.bg:addChild(self.musicSlider)]]

  self.musicSlider = ccui.Slider:create()
  self.musicSlider:setTouchEnabled(true)
  self.musicSlider:loadBarTexture("buyu2/res/setting/silder_bg.png")
  self.musicSlider:loadSlidBallTextures("buyu2/res/setting/Silder_Thumb.png", "buyu2/res/setting/Silder_Thumb.png", "")
  self.musicSlider:loadProgressBarTexture("buyu2/res/setting/silder_bar.png")
  ...
  self.effectSlider:loadBarTexture("buyu2/res/setting/silder_bg.png")
  self.effectSlider:loadSlidBallTextures("buyu2/res/setting/Silder_Thumb.png", "buyu2/res/setting/Silder_Thumb.png", "")
  self.effectSlider:loadProgressBarTexture("buyu2/res/setting/silder_bar.png")
  ...
  -- self.silenceCBox:loadTextures("buyu2/res/setting/open0.png",
  --                              "buyu2/res/setting/open0.png",
  --                              "buyu2/res/setting/open1.png",
  --                              "buyu2/res/setting/open0.png",
  --                              "buyu2/res/setting/open0.png")
  ...
  self.ExitBtn = ccui.Button:create("buyu2/res/setting/exit_btn_1.png","buyu2/res/setting/exit_btn_2.png")
...
function GameSetting:onExit()
    global.g_mainPlayer:setLocalData("buyu2_effect", self.effectPercent)
    global.g_mainPlayer:setLocalData("buyu2_music", self.musicPercent)
end
